...
export function expressUpdateShow(data) {
  return request({
    url: '/system/express/update/show',
    method: 'post',
    data
  })
}
...
export function shippingTemplatesList(data) {
  return request({
    url: '/system/express/shipping/templates/list',
    method: 'get',
    params: { ...data }
  })
}
...
export function templateDetailApi(data) {
  return request({
    url: '/system/express/shipping/templates/info',
    method: 'get',
    params: { ...data }
  })
}
...
export function shippingFree(data) {
  return request({
    url: '/system/express/shipping/free/list',
    method: 'get',
    params: { ...data }
  })
}
...
export function shippingRegion(data) {
  return request({
    url: '/system/express/shipping/region/list',
    method: 'get',
    params: { ...data }
  })
}
...
export function shippingSave(data) {
  return request({
    url: '/system/express/shipping/templates/save',
    method: 'post',
    data: data
  })
}
...
export function shippingUpdate(data, id) {
  return request({
    url: '/system/express/shipping/templates/update',
    method: 'post',
    data: data,
    params: { ...id }
  })
...
export function shippingDetete(data) {
  return request({
    url: '/system/express/shipping/templates/delete',
    method: 'get',
    params: data
  })
}
