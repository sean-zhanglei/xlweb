...
export function storeUpdateStatusApi(data) {
  return request({
    url: '/system/store/update/status',
    method: 'get',
    params: data
  })
}
...
export function allDeleteApi(params) {
  return request({
    url: '/system/store/completely/delete',
    method: 'get',
    params
  })
}
...
export function storeStaffUpdateStatusApi(data) {
  return request({
    url: '/system/store/staff/update/status',
    method: 'get',
    params: data
  })
}
