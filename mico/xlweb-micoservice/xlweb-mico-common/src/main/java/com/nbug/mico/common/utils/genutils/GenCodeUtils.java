...
public class GenCodeUtils {
    ...
    public static void generatorCode(Map<String, String> table,
        ...
        mainPath = StringUtils.isBlank(mainPath) ? "com.xlweb" : mainPath;
        ...
        for (String template : templates) {
            ...
            try {
                ...
                throw new XlwebException("Play Up Template Failed：" + tableEntity.getTableName()+e.getMessage());
            }
        }
    }
    ...
    public static Configuration getConfig() {
        try {
            ...
            throw new XlwebException("Get config Failed，" + e.getMessage());
        }
    }
