...
import com.nbug.mico.common.enums.DocumentEnum;
import com.nbug.depends.mq.redis.core.RedisMQTemplate;
import com.nbug.depends.mq.redis.core.job.RedisPendingMessageResendJob;
import com.nbug.depends.mq.redis.core.pubsub.AbstractRedisChannelMessageListener;
import com.nbug.depends.mq.redis.core.stream.AbstractRedisStreamMessageListener;
...
public class XlwebRedisMQConsumerAutoConfiguration {
