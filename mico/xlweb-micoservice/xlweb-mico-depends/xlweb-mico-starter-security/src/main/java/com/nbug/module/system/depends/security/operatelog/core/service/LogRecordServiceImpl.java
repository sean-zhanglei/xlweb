package com.nbug.module.system.depends.security.operatelog.core.service;
...
public class LogRecordServiceImpl implements ILogRecordService {
    ...
    public void record(LogRecord logRecord) {
        OperateLog reqDTO = new OperateLog();
        try {
    ...
    public static void fillModuleFields(OperateLog reqDTO, LogRecord logRecord) {
        ...
        reqDTO.setAction(logRecord.getAction());// 操作内容，例如：修改编号为 1 的用户信息，将性别从男改成女，将姓名从NBUG改成源码。
