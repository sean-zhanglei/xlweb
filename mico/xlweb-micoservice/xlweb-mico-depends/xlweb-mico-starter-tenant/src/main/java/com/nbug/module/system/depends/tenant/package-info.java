 ...
 *      1）Spring Async：
 *          {@link com.nbug.depends.quartz.config.XlwebAsyncAutoConfiguration#threadPoolTaskExecutorBeanPostProcessor()}
 *      2）Spring Security：
 *          TransmittableThreadLocalSecurityContextHolderStrategy
 *          和 XlwebSecurityAutoConfiguration#securityContextHolderMethodInvokingFactoryBean() 方法
 *
 */
package com.nbug.module.system.depends.tenant;
