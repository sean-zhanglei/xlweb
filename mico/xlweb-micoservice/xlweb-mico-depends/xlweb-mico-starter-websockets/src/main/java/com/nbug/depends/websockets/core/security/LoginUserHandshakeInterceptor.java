package com.nbug.depends.websockets.core.security;
 ...
 *
 * 流程如下：
 * 1. 前端连接 websocket 时，会通过拼接 ?token={token} 到 ws:// 连接后，这样它可以被 {@link JwtFrontAuthenticationTokenFilter} 所认证通过
 * 2. {@link LoginUserHandshakeInterceptor} 负责把 {@link LoginUserVo} 添加到 {@link WebSocketSession} 中
 *
 * @author NBUG
 */
