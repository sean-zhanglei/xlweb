package com.nbug.depends.websockets.core.sender.rocketmq;
...
@RocketMQMessageListener( // 重点：添加 @RocketMQMessageListener 注解，声明消费的 topic
        topic = "${xlweb.websocket.sender-rocketmq.topic}",
        consumerGroup = "${xlweb.websocket.sender-rocketmq.consumer-group}",
