package com.nbug.mico.gateway.filter.logging;
...
import com.nbug.mico.gateway.util.SecurityFrameworkUtils;
import com.nbug.mico.gateway.util.WebFrameworkUtils;
 ...
 * 网关的访问日志过滤器
 *
 * 从功能上，它类似 xlweb-spring-boot-starter-web 的 ApiAccessLogFilter 过滤器
 *
 * TODO NBUG：如果网关执行异常，不会记录访问日志，后续研究下 https://github.com/Silvmike/webflux-demo/blob/master/tests/src/test/java/ru/hardcoders/demo/webflux/web_handler/filters/logging
 *
 * @author NBUG
 */
@Slf4j
