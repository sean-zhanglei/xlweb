...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.nbug";
    private static final String ARTIFACT_ID = "xlweb";
    private static final String PACKAGE_NAME = "com.nbug";
    private static final String TITLE = "NBUG管理系统";
