...
@Slf4j
@RestController
@RequestMapping("api/admin/infra/system/attachment")
...
public class SystemAttachmentController {
    ...
    public CommonResult<CommonPage<SystemAttachment>>  getList(
            @RequestParam @Valid Integer pid,
            @RequestParam(
                    value = "attType",
    ...
    public CommonResult<String> save(@RequestBody @Valid SystemAttachmentRequest systemAttachmentRequest) {
    ...
    public CommonResult<String> update(@RequestParam Integer id,
                                       @RequestBody @Valid SystemAttachmentRequest systemAttachmentRequest) {
    ...
    public CommonResult<String> updateAttrId(@RequestBody @Valid SystemAttachmentMoveRequest move) {
