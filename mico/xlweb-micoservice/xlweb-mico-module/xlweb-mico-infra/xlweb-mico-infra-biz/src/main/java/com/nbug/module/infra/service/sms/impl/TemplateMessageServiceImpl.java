...
import com.nbug.mico.common.vo.ProgramTemplateMessageVo;
...
import com.nbug.mico.common.vo.SendProgramTemplateMessageItemVo;
import com.nbug.mico.common.vo.SendTemplateMessageItemVo;
import com.nbug.mico.common.vo.TemplateMessageVo;
import com.nbug.module.infra.dal.TemplateMessageDao;
...
//                boolean result = weChatService.sendPublicTempMessage(templateMessage);
    ...
    public Boolean updateStatus(Integer id, Integer status) {
        ...
        if (ObjectUtil.isNull(templateMessage)) {
            throw new XlwebException("此模板" + id + " 不存在或者已删除");
        }
    ...
    public Boolean whcbqhnSync() {
        ...
        if (CollUtil.isEmpty(templateMessageList)) {
            throw new XlwebException("请先添加公众号模板消息");
        }
    ...
    public Boolean routineSync() {
        ...
        if (CollUtil.isEmpty(templateMessageList)) {
            throw new XlwebException("请先配置小程序订阅消息");
        }
        // 获取当前帐号下的个人模板列表
