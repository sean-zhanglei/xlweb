...
public interface OAuth2TokenApi {
    ...
    CommonResult<OAuth2AccessTokenRespDTO> createAccessToken(@Validated @RequestBody OAuth2AccessTokenCreateReqDTO reqDTO);
    ...
    @Parameters({
        ...
        @Parameter(name = "clientId", description = "客户端编号", required = true, example = "xlweb")
    })
