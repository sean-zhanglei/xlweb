<template>
  <div class="order-index" ref="container">
    <div class="header acea-row">
      <router-link class="item" :to="'/mobile/orderList/unPaid'">
        <div class="num">{{ census.unpaidCount }}</div>
        <div>待付款</div>
      </router-link>
      <router-link class="item" :to="'/mobile/orderList/notShipped'">
        <div class="num">{{ census.unshippedCount }}</div>
        <div>待发货</div>
      </router-link>
      <router-link class="item" :to="'/mobile/orderList/spike'">
        <div class="num">{{ census.receivedCount }}</div>
        <div>待收货</div>
      </router-link>
      <router-link class="item" :to="'/mobile/orderList/toBeWrittenOff'">
        <div class="num">{{ census.verificationCount }}</div>
        <div>待核销</div>
      </router-link>
      <router-link class="item" :to="'/mobile/orderList/refunding'">
    ...
    <div class="wrapper">
      ...
      <div class="list acea-row">
        <router-link class="item" :to="'/mobile/orderStatisticsDetail/price/today'">
          <div class="num">{{ census.todayPrice }}</div>
          <div>今日成交额</div>
        </router-link>
        <router-link class="item" :to="'/mobile/orderStatisticsDetail/price/yesterday'">
          <div class="num">{{ census.proPrice }}</div>
          <div>昨日成交额</div>
        </router-link>
        <router-link class="item" :to="'/mobile/orderStatisticsDetail/price/month'">
          <div class="num">{{ census.monthPrice }}</div>
          <div>本月成交额</div>
        </router-link>
        <router-link class="item" :to="'/mobile/orderStatisticsDetail/order/today'">
          <div class="num">{{ census.todayCount }}</div>
          <div>今日订单数</div>
        </router-link>
        <router-link class="item" :to="'/mobile/orderStatisticsDetail/order/yesterday'">
          <div class="num">{{ census.proCount }}</div>
          <div>昨日订单数</div>
        </router-link>
        <router-link class="item" :to="'/mobile/orderStatisticsDetail/order/month'">
