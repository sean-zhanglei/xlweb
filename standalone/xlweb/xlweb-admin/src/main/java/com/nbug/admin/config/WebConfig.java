...
import com.nbug.admin.filter.ResponseFilter;
import com.nbug.common.config.XlwebConfig;
import com.nbug.common.constants.Constants;
import com.nbug.common.interceptor.SwaggerInterceptor;
...
//                excludePathPatterns("/swagger-resources/**", "/webjars/**", "/v2/**", "/swagger-ui.html/**");
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        ...
        registry.addResourceHandler(Constants.UPLOAD_TYPE_IMAGE + "/**")
                .addResourceLocations("file:" + xlwebConfig.getImagePath() + "/" + Constants.UPLOAD_TYPE_IMAGE + "/");
    }
