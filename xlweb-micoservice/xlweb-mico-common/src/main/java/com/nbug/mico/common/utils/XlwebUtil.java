package com.nbug.mico.common.utils;
...
//		System.out.println(decryptPassowrd("", ""));
        ...
        System.out.println(encryptPassword("xlweb@123456", "18292417675"));
    ...
    public static String getValueByIndex(HashMap<Integer, String> list, String categoryIdStr){
        ...
        List<Integer> idList = XlwebUtil.stringToArray(categoryIdStr);
...
//        setScaler(1,BigDecimal.ROUND_HALF_DOWN);//四舍五入，2.35变成2.3，如果是5则向下舍
    ...
    public static String getSign(Map<String, Object> map, String signKey){
        String result = XlwebUtil.mapToStringUrl(map) + "&key=" + signKey;
