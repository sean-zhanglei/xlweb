package com.nbug.module.infra.controller.admin.codegen;
...
import com.nbug.module.infra.controller.admin.codegen.vo.CodegenDetailRespVO;
import com.nbug.module.infra.controller.admin.codegen.vo.CodegenPreviewRespVO;
...
import com.nbug.module.infra.controller.admin.codegen.vo.table.CodegenTableRespVO;
import com.nbug.module.infra.controller.admin.codegen.vo.table.DatabaseTableRespVO;
import com.nbug.module.infra.convert.codegen.CodegenConvert;
...
import com.nbug.module.infra.framework.file.core.utils.FileTypeUtils;
import com.nbug.module.infra.service.codegen.CodegenService;
...
public class CodegenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "name", description = "表名，模糊匹配", example = "xlweb"),
            @Parameter(name = "comment", description = "描述，模糊匹配", example = "NBUG")
    })
