package com.nbug.module.infra.service.codegen;

import cn.hutool.core.collection.ListUtil;
import cn.hutool.core.map.MapUtil;
import com.nbug.common.pojo.PageResult;
import com.nbug.depends.test.core.ut.BaseDbUnitTest;
import com.nbug.module.infra.controller.admin.codegen.vo.CodegenCreateListReqVO;
import com.nbug.module.infra.controller.admin.codegen.vo.CodegenUpdateReqVO;
import com.nbug.module.infra.controller.admin.codegen.vo.column.CodegenColumnSaveReqVO;
import com.nbug.module.infra.controller.admin.codegen.vo.table.CodegenTablePageReqVO;
import com.nbug.module.infra.controller.admin.codegen.vo.table.DatabaseTableRespVO;
import com.nbug.module.infra.dal.dataobject.codegen.CodegenColumnDO;
import com.nbug.module.infra.dal.dataobject.codegen.CodegenTableDO;
import com.nbug.module.infra.dal.mysql.codegen.CodegenColumnMapper;
import com.nbug.module.infra.dal.mysql.codegen.CodegenTableMapper;
import com.nbug.module.infra.enums.codegen.CodegenFrontTypeEnum;
import com.nbug.module.infra.enums.codegen.CodegenSceneEnum;
import com.nbug.module.infra.enums.codegen.CodegenTemplateTypeEnum;
import com.nbug.module.infra.framework.codegen.config.CodegenProperties;
import com.nbug.module.infra.service.codegen.inner.CodegenBuilder;
import com.nbug.module.infra.service.codegen.inner.CodegenEngine;
import com.nbug.module.infra.service.db.DatabaseTableService;
...
import static com.nbug.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static com.nbug.common.util.date.LocalDateTimeUtils.buildTime;
import static com.nbug.common.util.object.ObjectUtils.cloneIgnoreId;
import static com.nbug.depends.test.core.util.AssertUtils.assertPojoEquals;
import static com.nbug.depends.test.core.util.AssertUtils.assertServiceException;
import static com.nbug.depends.test.core.util.RandomUtils.*;
import static com.nbug.infra.enums.ErrorCodeConstants.*;
