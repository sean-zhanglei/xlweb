package com.nbug.module.infra.service.file;
...
import com.nbug.module.infra.controller.admin.file.vo.config.FileConfigSaveReqVO;
import com.nbug.module.infra.dal.dataobject.file.FileConfigDO;
import com.nbug.module.infra.dal.mysql.file.FileConfigMapper;
import com.nbug.module.infra.framework.file.core.client.FileClient;
import com.nbug.module.infra.framework.file.core.client.FileClientConfig;
import com.nbug.module.infra.framework.file.core.client.FileClientFactory;
import com.nbug.module.infra.framework.file.core.client.local.LocalFileClient;
import com.nbug.module.infra.framework.file.core.client.local.LocalFileClientConfig;
import com.nbug.module.infra.framework.file.core.enums.FileStorageEnum;
import lombok.Data;
...
import static com.nbug.depends.test.core.util.RandomUtils.randomLongId;
import static com.nbug.depends.test.core.util.RandomUtils.randomPojo;
import static com.nbug.infra.enums.ErrorCodeConstants.FILE_CONFIG_DELETE_FAIL_MASTER;
import static com.nbug.infra.enums.ErrorCodeConstants.FILE_CONFIG_NOT_EXISTS;
...
public class FileConfigServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetFileConfigPage() {
        // mock 数据
        FileConfigDO dbFileConfig = randomFileConfigDO().setName("NBUG")
