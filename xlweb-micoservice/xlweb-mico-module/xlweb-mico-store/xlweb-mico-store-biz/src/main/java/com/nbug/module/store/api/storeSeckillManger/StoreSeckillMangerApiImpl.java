...
@Validated
public class StoreSeckillApiImpl implements StoreSeckillApi {
    ...
    public CommonResult<Boolean> operationStock(Integer id, Integer num, String type) {
        return success(storeSeckillService.operationStock(id, num, type));
    }
    ...
    public CommonResult<StoreSeckill> getByIdException(Integer id) {
        return success(storeSeckillService.getByIdException(id));
    }
}
