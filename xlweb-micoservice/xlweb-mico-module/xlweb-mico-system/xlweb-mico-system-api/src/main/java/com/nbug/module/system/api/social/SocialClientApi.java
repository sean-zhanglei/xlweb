package com.nbug.module.system.api.social;

import com.nbug.mico.common.pojo.CommonResult;
import com.nbug.module.system.api.social.dto.SocialWxaSubscribeMessageSendReqDTO;
import com.nbug.module.system.api.social.dto.SocialWxaSubscribeTemplateRespDTO;
import com.nbug.module.system.enums.ApiConstants;
import com.nbug.module.system.api.social.dto.SocialWxJsapiSignatureRespDTO;
import com.nbug.module.system.api.social.dto.SocialWxPhoneNumberInfoRespDTO;
import com.nbug.module.system.api.social.dto.SocialWxQrcodeReqDTO;
...
public interface SocialClientApi {
    ...
    @Parameters({
            @Parameter(name = "userType", description = "用户类型", example = "1", required = true),
            @Parameter(name = "phoneCode", description = "手机授权码", example = "xlweb11", required = true)
    })
