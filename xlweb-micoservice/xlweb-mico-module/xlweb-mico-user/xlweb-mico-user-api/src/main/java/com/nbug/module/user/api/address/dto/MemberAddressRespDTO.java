package com.nbug.module.user.api.address.dto;
...
public class MemberAddressRespDTO {
    ...
    @Schema(description = "收件人名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "NBUG")
    private String name;
    ...
    @Schema(description = "收件详细地址", requiredMode = Schema.RequiredMode.REQUIRED, example = "NBUG 88 小区 106 号")
