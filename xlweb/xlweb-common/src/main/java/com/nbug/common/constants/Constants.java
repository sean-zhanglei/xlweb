package com.nbug.common.constants;
...
public class Constants {
    ...
    //用户登录密码加密混淆字符串
    public static final String USER_LOGIN_PASSWORD_MD5_KEYWORDS = "xlweb";
    ...
    //上传类型
    public static final String UPLOAD_TYPE_IMAGE = "xlwebimage";
...
//    public static final String CONFIG_KEY_PUBLIC_LOGO = "wechat_avatar"; //公众号logo
    ...
    /** 公共JS配置 */
    // XLWEB chat 统计
    public  static final String JS_CONFIG_XLWEB_CHAT_TONGJI="xlweb_tongji_js";
}
