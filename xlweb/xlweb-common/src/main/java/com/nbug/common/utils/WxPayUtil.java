...
import com.nbug.common.vo.CreateOrderRequestVo;
...
public class WxPayUtil {
    ...
    public static HashMap<String, Object> processResponseXml(String xmlStr) throws Exception {
        ...
        if (respData.containsKey(RETURN_CODE)) {
            ...
            throw new XlwebException(String.format("No `return_code` in XML: %s", xmlStr));
        }
        ...
        if (return_code.equals(Constants.FAIL)) {
            ...
            throw new XlwebException(String.format("return_code value %s is invalid in XML: %s", return_code, xmlStr));
        }
    }
    ...
    public static String getNonceStr() {
        return DigestUtils.md5Hex(XlwebUtil.getUuid() + XlwebUtil.randomCount(111111, 666666));
    }
