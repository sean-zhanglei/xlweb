...
import com.nbug.common.request.SystemStoreStaffRequest;
import com.nbug.common.response.SystemStoreStaffResponse;
import com.github.pagehelper.Page;
import com.github.pagehelper.PageHelper;
import com.github.pagehelper.PageInfo;
import com.nbug.common.model.system.SystemStore;
import com.nbug.common.model.system.SystemStoreStaff;
import com.nbug.common.model.user.User;
import com.nbug.service.dao.SystemStoreStaffDao;
import com.nbug.service.service.SystemStoreService;
import com.nbug.service.service.SystemStoreStaffService;
...
public class SystemStoreStaffServiceImpl extends ServiceImpl<SystemStoreStaffDao, SystemStoreStaff> implements SystemStoreStaffService {
    ...
    public Boolean saveUnique(SystemStoreStaffRequest request) {
        ...
        if (CollUtil.isNotEmpty(existStaffs) && existStaffs.size() > 0) throw new XlwebException(Constants.RESULT_VERIFICATION_USER_EXIST);
    ...
    public Boolean updateStatus(Integer id, Integer status) {
        ...
        if (ObjectUtil.isNull(systemStoreStaff)) {
            throw new XlwebException("核销员不存在");
        }
